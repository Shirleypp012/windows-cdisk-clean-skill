<p align="center">
  ...
  <img src="https://img.shields.io/badge/AI-CLAUDE%20%7C%20Grok%20%7C%20OpenAI%20Codex-8B5CF6?style=flat-square" alt="AI">
...
<p align="center">
  <picture>
    ...
    <img src="https://img.shields.io/badge/Disk%20Clean-Pro-2563EB?style=for-the-badge" alt="Disk Clean Pro">
  </picture>
</p>
...
<p align="center">
  ...
  <a href="#-project-structure">
    <img src="https://img.shields.io/badge/📖_Documentation-6B7280?style=for-the-badge" alt="Documentation" height="48">
  </a>
</p>
...
<p align="center">
  <picture>
    ...
    <img src="https://placehold.co/960x540/F8FAFC/64748B?text=Product+Screenshot+Coming+Soon&font=Inter" alt="Product Screenshot" width="100%" style="max-width: 960px; border-radius: 16px; border: 1px solid #E2E8F0;">
  </picture>
</p>
...
<table align="center">
  <tr>
    <td align="center" width="33%">
      <br>
      <img src="https://img.shields.io/badge/🛡️-1A1A1A?style=flat-square" width="48" height="48"><br><br>
    ...
    <td align="center" width="33%">
      <br>
      <img src="https://img.shields.io/badge/🧠-1A1A1A?style=flat-square" width="48" height="48"><br><br>
...
```mermaid
flowchart LR
    A["👤 User Trigger<br>/cdisk-clean"] --> B["🔬 Phase 1<br>Full Scan"]
    B --> C["📊 Phase 2<br>Risk Classification"]
    C --> D{Classification}

    D -->|"🛑 System Core"| E["🔒 Auto-Skipped<br>Permanently Protected"]
    D -->|"✅ Safe Files"| F["⚡ Auto-Cleaned<br>Space Released"]
    D -->|"⚠️ High Risk"| G["👆 Listed with Details<br>Awaiting Confirmation"]

    E --> H["📋 Phase 3<br>Six-Section Report"]
    F --> H
    G -->|"User confirms"| H

    H --> I["✅ Final Summary<br>X.XX GB Freed"]
```
